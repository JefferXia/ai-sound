    ...
    <div className="max-w-6xl px-4 py-8 pt-24 mx-auto sm:px-6 lg:px-8">
      <div className="sm:flex sm:flex-col sm:align-center">
        ...
        <p className="max-w-2xl m-auto mt-5 text-xl dark:text-zinc-200 sm:text-center sm:text-2xl">
          极效火眼集成了最强大的AI功能，助你开启短视频AI创作之路，免费试用功能有限，添加会员计划能解锁更多其他功能。
        </p>
      </div>
      ...
      <div className="mt-12 grid grid-cols-4 gap-6">
        <div className="flex flex-col rounded-xl shadow-sm bg-muted">
          <div className="p-6">
            <h2 className="text-2xl font-semibold leading-6">免费试用</h2>
            <p className="mt-8">
        ...
        <div className="flex flex-col rounded-xl shadow-sm bg-muted">
          <div className="p-6">
            <h2 className="text-2xl font-semibold leading-6">基础版</h2>
            <p className="mt-8">
              <span className="text-4xl font-extrabold tracking-tight">
            ...
            <Button className="mt-8 w-full">订阅</Button>
            <p className="flex items-center mt-4 text-zinc-400">
              <Check size={18} className="text-green-500 mr-2" />
              一次性发放500积分
            </p>
        ...
        <div className="flex flex-col rounded-xl shadow-sm bg-muted">
          <div className="p-6">
            <h2 className="text-2xl font-semibold leading-6">高级版</h2>
            <p className="mt-8">
              <span className="text-4xl font-extrabold tracking-tight">
        ...
        <div className="flex flex-col rounded-xl shadow-sm bg-muted">
          <div className="p-6">
            <h2 className="text-2xl font-semibold leading-6">企业版</h2>
            <p className="mt-8">
              <span className="text-4xl font-extrabold tracking-tight">
